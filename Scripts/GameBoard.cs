...
public class GameBoard : MonoBehaviour
{
	...
	public bool didSpawnBonusItem1_player1;
	public bool didSpawnBonusItem2_player1;
	public bool didSpawnBonusItem1_player2;
	public bool didSpawnBonusItem2_player2;
    ...
    void Start()
    {
        ...
        foreach (GameObject o in objects){
        	...
        	if(o.name != "PacMan" && o.name != "Nodes" && o.name!="NonNodes" && o.name != "Maze" &&
        	 o.name != "bottom_left_corner_single" && o.name != "Pellets" && o.name != "Ghost" && o.tag != "Ghost" &&
        	 o.tag != "ghostHome" && o.name != "Canvas" && o.tag!= "UIElements"){
    ...
    public void StartGame(){
    	...
    	} else StartCoroutine (StartBlinking(playerTwoUp));
		...
		if(GameMenu.livesPlayerOne==0 && GameMenu.livesPlayerTwo==0){
			...
			if(GameMenu.livesPlayerOne==0){
				...
				if(!GameMenu.isOnePlayerGame)
					...
					readyText.transform.GetComponent<Text> ().color = new Color(240f/255f, 207f/255, 101f/255f);
	...
	public void Restart(){
		...
		foreach(GameObject ghosts in obj){
			ghosts.transform.GetComponent<Ghost> ().SetDifficultyForLevel(playerLevel);
		}
